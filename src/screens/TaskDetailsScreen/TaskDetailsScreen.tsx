...
export const TaskDetailsScreen: React.FC = () => {
  ...
  const handleToggleCompletion = async () => {
    ...
    try {
      ...
      setTask({ ...task, completed: !task.completed, endedAt: !task.completed ? new Date().toISOString() : "A task nao foi completa ainda" });
    } catch (error) {
          ...
          {isEditing ? (
            ...
            <>
              ...
              <ThemedView style={styles.section}>
                ...
                <ThemedText style={styles.dateText}>
                  {task.completed ? formatDate(task.endedAt) : task.endedAt}
                </ThemedText>
              </ThemedView>
            </>
          )}
